                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <form action="" method="get">
                                ...
                                <br>
                                <div align="center">
                                    <input type="submit" class="btn btn-primary shadow" value="เข้าสู่ระบบ">
                                </div>
                            ...
                            <br>
                            <div align="center">
                                <a href="../page_login_user/register.php" style="text-decoration: none;">สำหรับผู้ใช้ที่ไม่มีบัญชี</a>
                            </div>
